...
/**
 * State interface of the controller. Implements the general description of a
 * State.
 */
public interface State {
	/**
	 * Method called by the controller after a click on the button "Load a map" and
	 * the selection of a xml file containing the map, in the file system.
	 * 
	...
	/**
	 * Method called by the controller after a click on the button "Load a set of
	 * requests" and the selection of a xml file containing the set of requests, in
	 * the file system.
	 * 
	 * @param a    the controller of the application
	 * @param hw   the main window of the application
	 * @param fp   the file path to the map (xml file)
	 * @param tour the tour that will use the map
	 */
	...
	/**
	 * Method called by the controller when a point (an intersection) is selected on
	 * the map in one of the process of adding a request, or when deleting a
	 * request.
	 * 
	 ...
	 * 
	 * @param a  the application to call cancel on
	 * @param hw the homeWindow (view) to call cancel on
	 */
	public default void cancel(Application a, HomeWindow hw) {
	}

	/**
	 * Method called by the States to display a message about specific information

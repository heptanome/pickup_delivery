...
public class Request {
	 ...
	 * Constructor
	 * 
	 * @param delivAdd   Intersection representing the delivery address
	 * @param pickupAddr Intersection representing the pickup address
	 * @param delivDur   time in minutes needed by the delivery man to deliver the
	 *                   item
	 * @param pickupDur  time in minutes needed by the delivery man to pick the item
	 * @param numeroReq  Request number
	 */
	 ...
	 * 
	 * @param newPickup new intersection for the pickup address
	 */
	 ...
	 * 
	 * @param newDelivery new intersection for the delivery address
	 */
	 ...
	 * 
	 * @param duration Time in minutes the delivery man needs to pick up the item
	 */
	 ...
	 * 
	 * @param duration Time in minutes the delivery man needs to deliver the item
	 */
